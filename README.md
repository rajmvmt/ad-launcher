<p align="center">
  <img src="frontend/public/breadwinner_logo.png" alt="MVMT Printer" width="120" />
</p>

<h1 align="center">MVMT Printer</h1>
...
MVMT Printer is a full-stack application that streamlines the entire Facebook advertising workflow. Use AI to research competitors, generate compelling ad copy and images, and manage campaigns—all from one platform.
...
```bash
git clone https://github.com/yourusername/mvmt_printer.git
cd mvmt_printer
./setup.sh
```
