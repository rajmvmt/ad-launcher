#!/bin/bash
#
# MVMT Printer - Interactive Setup Script
...
echo "  ╔═══════════════════════════════════════════════════════════╗"
echo "  ║                                                           ║"
echo "  ║            🚀 MVMT Printer Setup Wizard 🚀                ║"
echo "  ║                                                           ║"
echo "  ╚═══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
echo ""
echo "  This wizard will help you set up MVMT Printer."
...
if [ "$SKIP_ENV" != "true" ]; then
    ...
    prompt "Enter your DATABASE_URL" "postgresql://user:password@localhost:5432/mvmt_printer" DATABASE_URL
