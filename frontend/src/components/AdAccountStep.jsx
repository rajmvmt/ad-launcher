...
import { ChevronRight, Loader, Building2, CreditCard, TrendingUp, Calendar, DollarSign, AlertCircle, Link2 } from 'lucide-react';
...
const AdAccountStep = ({ onNext }) => {
    ...
    const { selectedAdAccount, setSelectedAdAccount, selectedConnection, setSelectedConnection } = useCampaign();
            ...
            {connections.length > 0 && (
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 mb-4">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                        <Link2 size={14} className="inline mr-1" /> Facebook Connection
                    </label>
                    <select
